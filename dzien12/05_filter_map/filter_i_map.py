...
parzyste2 = filter(lambda x: x%2 == 0, liczby) # print(list(parzyste2)) bo bez list nie daje listy
print(parzyste2)
for p in parzyste2:
    print(p, end=', ')
print()
...
# z kolei gdy zastosować jakąś funkcję, np. podnoszenie do kwadratu dla każdego elementu listy,
# to możemy:
# napisać klasyyczną pętlę
