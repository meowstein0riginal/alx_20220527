...
def funkcja2():
    print('a:', a)
    # ERR print('b:', b)
    # nawet jeśli ta funkcja została wywołana przez funkcja1 (gdzie była zmienna b), to tutaj zmiennej B nie widać


funkcja1()
# po zakończeniu finkcji nie ma dostępu do zmiennych lokalnych wprowadzonych w tej funkcji
# print('b:', b)
...
def funkcja3():
    # tutaj zmienną globalną przesłąniamy za pomocą zmiennej lokalnej o tej samej nazwie
    c = 200
    print('c:', c)
    wypisz_c() # ??
...
def funkcja6(param1, param2):
    ...
    print('odczytuje globalne c z wnętrza funkcji:', globals()['c'])
